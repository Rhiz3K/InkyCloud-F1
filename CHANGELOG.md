...
- **Static analysis consistency** - Keep DeepSource test-code analysis enabled while excluding test artifacts from its documentation metric so it matches the enforced production `app` and `scripts` docstring scope
