...
- **Search Console sitemap compatibility** - Rebuilt `sitemap.xml` generation with escaped XML values, canonical localized page URLs, hreflang alternates, and a smaller indexable page set so Google can classify and crawl the submitted sitemap reliably
