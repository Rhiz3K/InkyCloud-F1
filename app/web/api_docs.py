...
def build_api_docs_context(ui_lang: str) -> dict[str, Any]:
    ...
    if ui_lang == "cs":
        ...
        curl_comment4 = "# B/W/R varianta pro černo-bílo-červený e-paper"
        ...
        return {
            ...
            "display_desc": "Režim výstupu pro 1bit, B/W/R nebo Spectra 6 displeje",
            ...
            "calendar_desc": (
                ...
                "pro 1bit, 4bit B/W/R a Spectra 6 E-Ink displeje."
            ),
            "eg": eg,
    ...
    curl_comment4 = "# B/W/R output for tri-color E-Ink"
    ...
    return {
        ...
        "display_desc": "Output mode for 1bit, B/W/R, or Spectra 6 displays",
        ...
        "calendar_desc": (
            ...
            "for 1bit, 4-bit B/W/R, and Spectra 6 E-Ink displays."
        ),
        "eg": eg,
