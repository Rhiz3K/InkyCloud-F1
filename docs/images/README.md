# Calendar render examples

These PNG previews show the actual 800 × 480 calendar BMP output with
`track_style=relief` and `track_accent=all`. They use the 2026 Spanish Grand Prix,
...
the [source manifests](../../artwork/open-tracks/). The map licence applies to the
map component, not to the entire calendar.

Race schedules and results: Jolpica-F1 / Ergast contributors, CC BY-NC-SA 4.0,
selected and formatted with local times. The project car, flag, supplementary
circuit facts and fonts retain the separate rights and provenance described in
[data licences](../../DATA_LICENSES.md) and [third-party notices](../../THIRD_PARTY_NOTICES.md).
